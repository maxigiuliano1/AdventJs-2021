/**
 * Invertir en criptomonedas es casi un deporte de riesgo. El otro día hackearon Bitmart y ha hecho que el valor de Bitcoin,
 *  y otras monedas, bajase un 25%.
...
function maxProfit(prices) {
    ...
    for(let price of prices){
      const benefitNextHour = price - lowerPrice
      if(price< lowerPrice){lowerPrice = price}
      if(price> lowerPrice && benefitNextHour > maxBenefit) maxBenefit = benefitNextHour
    }
