 ...
 * 
 * ¡Ten cuidado! Como has visto en el segundo ejemplo, el organigrama puede tener diferentes niveles y además 
 * nos viene información que puede ser que no necesitemos. 
...
function countPackages(carriers, carrierID) {
  ...
  const packagesFromSubordinates = subordinates.reduce(
    (total, subordinate) => total + countPackages(carriers, subordinate), 0
  )
