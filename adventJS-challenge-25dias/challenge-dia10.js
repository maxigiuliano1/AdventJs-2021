 ...
 * el mínimo número de monedas que debemos usar para dar el cambio de una compra en metálico.
...
function getCoins(change) {
    ...
    var resultado = []
    for(let i = 0; i<6; i++){
      var cantidad = Math.trunc(change/monedas[i])
      resultado[i] = cantidad
      change -= cantidad*monedas[i]
    }
